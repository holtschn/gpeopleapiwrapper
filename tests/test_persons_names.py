...
class TestPersonWrapperNames(tpb.FixtureMixin, unittest.TestCase):
    ...
    def test_read_names_attributes(self):
        person = TestPersonWrapperNames.read_fixture_tester_klaus()
        ...
        self.assertEqual("Klaus Tester", names.unstructured_name)
    ...
    def test_update_names_unstructured_name(self):
        ...
        self.assertEqual("[Updated] Klaus Tester", person.names.first().unstructured_name)
